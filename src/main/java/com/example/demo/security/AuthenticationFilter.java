...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	protected void successfulAuthentication(HttpServletRequest req,HttpServletResponse res,
		...
		String token=Jwts.builder()
				...
				.compact();
		System.out.println("tokenSecret from getTokenSecret==="+SecurityConstants.getTokenSecret());
		RegistrationServiceInterface userService=(RegistrationServiceInterface) SpringApplicationContext.getBean("registrationService");
		RegistrationDto userDto=userService.getByEmail(userName);
